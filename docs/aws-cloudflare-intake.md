...
clawhip daemon accepts push webhooks from AWS and Cloudflare and normalizes
...
topic_allowlist = ["arn:aws:sns:us-east-1:123456789012:clawhip-alarms"]
...
sink = "localfile"
local_path = "/var/log/clawhip/security.jsonl"
```
